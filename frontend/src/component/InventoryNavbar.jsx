...
const InventoryNavbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 px-4 py-3 flex justify-between items-center relative">
      <h1 className="text-lg font-bold text-gray-800">Hospital Inventory</h1>
